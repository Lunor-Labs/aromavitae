    ...
    <section className="reveal">
      <div className="grid md:grid-cols-2">
        ...
        <div className="relative bg-forest text-warm-white p-10 md:p-16 flex flex-col justify-center overflow-hidden">
          {/* Decorative botanical illustration overlay */}
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-bold leading-tight mb-6">
            Rooted in Nature.<br />Refined for Today.
          </h2>
          <p className="text-warm-white/80 text-sm leading-relaxed mb-8 max-w-md">
            Aromavitae is a celebration of Sri Lanka&apos;s rich natural
            heritage. From the spice gardens of Ceylon to the rare agarwood
            forests, we source the finest gifts of nature and craft them with
            care, to bring purity, authenticity, and timeless luxury to your
            life.
          </p>
          <Link
            href="/our-story"
        ...
        <div className="relative bg-cream p-10 md:p-16 flex flex-col justify-center">
          ...
          <div className="relative z-10">
            ...
            <p className="text-muted text-sm leading-relaxed mb-8 max-w-md">
              For generations, our artisans and farmers have perfected the art of
              cultivating, harvesting, and crafting the world&apos;s finest
              spices and agarwood.
            </p>

            {/* Heritage Badges */}
            <div className="flex flex-wrap gap-8 mb-8">
              {HERITAGE_BADGES.map((badge) => (
